...
public interface ContractorDao {
	...
	List<ContractorInstance> getInstances(int startIndex, int amount, EventsByContractorFilter filter, List<SortCriterion> sortCriteria);
	...
	void addFkrToContractor(KmFkr fkr, String contractorID);

	List<KmFkr> getContractorFkr(int startIndex, int amount, String contractorID);

	int getContractorFkrCount(String contractorID);
}

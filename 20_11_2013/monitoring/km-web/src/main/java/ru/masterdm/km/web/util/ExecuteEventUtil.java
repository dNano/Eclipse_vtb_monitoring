...
public class ExecuteEventUtil {
	...
	public final static String getDealInfo(KmEventInstance event, DateFormat dateFormat, DecimalFormat amountFormat) {
		String info = "";
		...
		if (deal != null) {
			...
			if (deal.getValidTo() != null) {
				...
				// info += "Соглашение № " + deal.getSpkpNumber() + " от " + dateFormat.format(deal.getValidTo()) + ", ";
				info += "Соглашение " + getOfficialInfo(event, dateFormat, null) + ", ";
			}
			if (deal.getType() != null && deal.getType().getName() != null) {
				info += deal.getType().getName();
			}
	 ...
	 * @return
	 */
	public final static String getOfficialInfo(KmEventInstance eventInst, DateFormat dateFormat, DecimalFormat amountFormat) {
		String info = "";
		OfficialInfo officialInfo = eventInst.getInfo();

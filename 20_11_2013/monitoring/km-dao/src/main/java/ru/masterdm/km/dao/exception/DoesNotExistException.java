...
public class DoesNotExistException extends BusinessException {
	 ...
	 * 
	 * @param cls
	 *            the class of the object being requested. It will be stripped down to its unqualified name (eg. jumpstart.Department would
	 *            be stripped down to Department) to be used as a message key when generating a message in getMessage().
	 * @param id
